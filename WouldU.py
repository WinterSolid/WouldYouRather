...
def main():
    ...
    while True:
        ...
        if q1 == "A":
            print("62% Accepted this choice!")
        elif q1 == "B":
            print("32% Accepted this choice!")
        elif q1 == "Q":
            print("Im Done!")
            break
        else:
        ...
        if q2 == "A":
            print("71% Accepted this choice!")
        elif q2 == "B":
            print("29% Accepted this choice!")
        elif q2 == "Q":
            print("Im Done!")
            break
        else:
        ...
        if q3 == "A":
            print("81% Accepted this choice!")
        elif q3 == "B":
            print("19% Accepted this choice!")
        elif q3 == "Q":
            print("Im Done!")
            break
        else:
        ...
        if q5 == "A":
            print("64% Accepted this choice!")
        elif q5 == "B":
            print("36% Accepted this choice!")
        elif q5 == "Q":
            print("Im Done!")
        else:
            print("play fair!")
